package com.gianmarco.soa.ride_request.entity;
...
@Table(name = "ride_requests", indexes = {
        @Index(name = "idx_ride_requests_client_id", columnList = "client_id"),
        @Index(name = "idx_ride_requests_driver_id", columnList = "driver_id"),
        @Index(name = "idx_ride_requests_status", columnList = "status"),
        @Index(name = "idx_ride_requests_client_status", columnList = "client_id, status")
})
