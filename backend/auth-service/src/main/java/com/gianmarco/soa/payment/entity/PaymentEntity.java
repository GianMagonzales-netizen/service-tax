package com.gianmarco.soa.payment.entity;
...
@Table(name = "payments", indexes = {
        @Index(name = "idx_payments_ride_request_id", columnList = "ride_request_id"),
        @Index(name = "idx_payments_client_id", columnList = "client_id"),
        @Index(name = "idx_payments_driver_id", columnList = "driver_id"),
