package com.gianmarco.soa.ride_assignment.entity;
...
@Table(name = "ride_assignments", indexes = {
        @Index(name = "idx_ride_assignments_ride_request_id", columnList = "ride_request_id"),
        @Index(name = "idx_ride_assignments_driver_id", columnList = "driver_id"),
        @Index(name = "idx_ride_assignments_status", columnList = "status"),
        @Index(name = "idx_ride_assignments_ride_request_status", columnList = "ride_request_id, status")
})
public class RideAssignmentEntity {
    ...
    protected void onCreate() {
        ...
        expiresAt = assignedAt.plusMinutes(5);
